...
<header class="border-b border-red-100 pb-4 mb-4">
<h2 class="text-lg font-semibold text-red-700">{{ __('Delete Account') }}</h2>
...
<x-text-input id="password" name="password" type="password" class="mt-1 block w-3/4 border-red-200 focus:border-red-500 focus:ring-red-500" placeholder="{{ __('Password') }}" />
